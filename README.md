...
<div>Версия аддона в beta 0.9 и он может проделать следующую работу:<div></p>
<ol>
...
<li style="text-align: justify;">Записать и проинформировать особенности предстоящего сражения.</li>
...
<div>Beta version of addon is 0.9 and he can do next features:<div></p>
<ol>
...
<li style="text-align: justify;">Write and anounce about fight.</li>
